...
import com.github.alecmus.customeronboardingextended.rest.CustomerOnboardingRestController;
...
public class TestCustomerOnboardingProcess {
	...
	public void setupMocks() {
		// Can't simply use the autowired MockRestServiceServer as I have to set "ignoreExpectOrder" for the parallel paths
	...
	public void testAutomaticOnboarding() throws Exception {
		...
		// Let's assert that it passed certain BPMN elements
