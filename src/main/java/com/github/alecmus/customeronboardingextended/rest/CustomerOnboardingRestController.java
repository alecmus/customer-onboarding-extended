package com.github.alecmus.customeronboardingextended.rest;
...
public class CustomerOnboardingRestController {
    ...
    private static Logger logger = LoggerFactory.getLogger(CustomerOnboardingRestController.class);
    ...
    public ResponseEntity<CustomerOnboardingResponse> onboardCustomer(ServerWebExchange exchange) {
        logger.info("PUT request received at /customer");
    ...
    public long onboardCustomer(String paymentType, int monthlyPayment, int customerRegionScore) {
        ...
        logger.info("Creating new instance of process (blocking)");
